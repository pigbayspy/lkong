...
class ThemeConfig(val context: Context, val key: String) {
    ...
    fun primaryColor(@ColorInt color: Int): ThemeConfig {
        editor.putInt(ThemeUtil.KEY_PRIMARY_COLOR, color)
    ...
    fun accentColor(@ColorInt color: Int): ThemeConfig {
        editor.putInt(ThemeUtil.KEY_ACCENT_COLOR, color)
        return this
    }

    fun textColorPrimary(@ColorInt color: Int): ThemeConfig {
        editor.putInt(ThemeUtil.KEY_TEXT_COLOR_PRIMARY, color)
        return this
    }

    fun textColorSecondary(@ColorInt color: Int): ThemeConfig {
        editor.putInt(ThemeUtil.KEY_TEXT_COLOR_SECONDARY, color)
        return this
    }

    fun lightStatusBarMode(mode: Int): ThemeConfig {
        editor.putInt(ThemeUtil.KEY_LIGHT_STATUS_BAR_MODE, mode)
        return this
    }

    fun coloredStatusBar(color: Boolean): ThemeConfig {
        editor.putBoolean(ThemeUtil.KEY_APPLY_PRIMARY_DARK_STATUS_BAR, color)
        return this
    }

    fun lightToolbarMode(mode: Int): ThemeConfig {
        editor.putInt(ThemeUtil.KEY_LIGHT_TOOLBAR_MODE, mode)
        return this
    }

    fun coloredNavigationBar(applyToNavBar: Boolean): ThemeConfig {
        editor.putBoolean(ThemeUtil.KEY_APPLY_PRIMARY_NAV_BAR, applyToNavBar)
        return this
    }
    ...
    fun coloredNavigationBar(context: Context, key: String): Boolean {
        return ThemeUtil.pref(context, key)
            .getBoolean(ThemeUtil.KEY_APPLY_PRIMARY_NAV_BAR, false)
    }
    ...
    private fun primaryColorDark(@ColorInt color: Int): ThemeConfig {
        editor.putInt(ThemeUtil.KEY_PRIMARY_COLOR_DARK, color)
        return this
    }
    ...
    companion object {
        ...
        private const val KEY_ACTIVITY_THEME_DEFAULT_TYPE = "activity_theme_default_type"
